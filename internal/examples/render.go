...
func renderMageCheckPreview(out io.Writer, printer *laslig.Printer) error {
	...
	if err := printer.Table(laslig.Table{
		...
		Rows: [][]string{
			...
			{"github.com/evanmschultz/laslig/examples/codeblock", "80.0%"},
			{"github.com/evanmschultz/laslig/examples/gotestout", "86.7%"},
			{"github.com/evanmschultz/laslig/examples/kv", "80.0%"},
			{"github.com/evanmschultz/laslig/examples/list", "80.0%"},
			{"github.com/evanmschultz/laslig/examples/logblock", "75.0%"},
			{"github.com/evanmschultz/laslig/examples/magecheck", "80.0%"},
			{"github.com/evanmschultz/laslig/examples/markdown", "80.0%"},
			{"github.com/evanmschultz/laslig/examples/notice", "80.0%"},
			{"github.com/evanmschultz/laslig/examples/panel", "80.0%"},
			{"github.com/evanmschultz/laslig/examples/paragraph", "80.0%"},
			{"github.com/evanmschultz/laslig/examples/record", "80.0%"},
			{"github.com/evanmschultz/laslig/examples/section", "80.0%"},
			{"github.com/evanmschultz/laslig/examples/statusline", "80.0%"},
			{"github.com/evanmschultz/laslig/examples/table", "80.0%"},
			{"github.com/evanmschultz/laslig/gotestout", "82.3%"},
			{"github.com/evanmschultz/laslig/internal/examples", "88.0%"},
			{"github.com/evanmschultz/laslig/internal/exampletestutil", "90.0%"},
...
func mageCheckSampleStream() string {
	packages := []struct {
		...
		{"github.com/evanmschultz/laslig/examples/codeblock", 2},
		{"github.com/evanmschultz/laslig/examples/gotestout", 8},
		{"github.com/evanmschultz/laslig/examples/kv", 2},
		{"github.com/evanmschultz/laslig/examples/list", 2},
		{"github.com/evanmschultz/laslig/examples/logblock", 5},
		{"github.com/evanmschultz/laslig/examples/magecheck", 2},
		{"github.com/evanmschultz/laslig/examples/markdown", 2},
		{"github.com/evanmschultz/laslig/examples/notice", 2},
		{"github.com/evanmschultz/laslig/examples/panel", 2},
		{"github.com/evanmschultz/laslig/examples/paragraph", 2},
		{"github.com/evanmschultz/laslig/examples/record", 2},
		{"github.com/evanmschultz/laslig/examples/section", 4},
		{"github.com/evanmschultz/laslig/examples/statusline", 2},
		{"github.com/evanmschultz/laslig/examples/table", 2},
		{"github.com/evanmschultz/laslig/gotestout", 14},
		{"github.com/evanmschultz/laslig/internal/examples", 18},
		{"github.com/evanmschultz/laslig/internal/exampletestutil", 8},
